...
namespace ExpressionSerialization
{
    public sealed class TypeResolver
    {
        ...
        public TypeResolver(IEnumerable<Assembly> assemblies = null, IEnumerable<Type> knownTypes = null)
        {
            ...
            this.knownTypes =
                new ReadOnlyCollection<Type>(new List<Type>(simpleTypes.Union(knownTypes ?? Type.EmptyTypes)));
        }
        ...
        /// <summary>
        ///     Checks if the input Type is "mapped" or otherwise somehow related (e.g. Array) to a KnownType found in
        ///     this.KnownTypes.
        /// </summary>
        ...
        public Type GetOrCreateAnonymousTypeFor(string name, NameTypePair[] properties, NameTypePair[] ctr_params)
        {
            ...
            var anonTypeBuilder = moduleBuilder.DefineType(anon_prefix + anonymousTypeIndex++,
            ...
            var constructorBuilder = anonTypeBuilder.DefineConstructor(
                ...
                CallingConventions.Standard, ctr_params.Select(prop => prop.Type).ToArray());
        ...
        private class AnonTypeId
        {
            ...
            public IEnumerable<NameTypePair> Properties { get; }
